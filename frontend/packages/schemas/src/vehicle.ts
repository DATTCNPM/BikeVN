...
export const vehicleCreationSchema = z.object({
  ...
  vehicleType: z.enum(["fuel", "electric"], { required_error: "Loại xe không hợp lệ" }),
  mileage: z.number().min(0, "Số ODO phải lớn hơn hoặc bằng 0"),
  description: z.string().optional(),
  status: z.enum(["available", "unavailable", "maintenance"], { required_error: "Trạng thái xe không hợp lệ" }),
