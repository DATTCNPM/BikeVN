import type { VehicleModelQueryParams } from "@repo/schemas";
export const vehicleModelKeys = {
  ...
  filters: () => [...vehicleModelKeys.all, "filter"] as const,
  filter: (params: VehicleModelQueryParams) =>
    [...vehicleModelKeys.filters(), params] as const,
