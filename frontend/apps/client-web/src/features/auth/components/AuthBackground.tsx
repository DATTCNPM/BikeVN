      ...
      >
        ...
        >
            ...
            style={{
              ...
              background: `
                linear-gradient(
                  ...
                  rgba(161,161,170,0.92) 18%,
                  rgba(82,82,91,0.88) 42%,
          ...
          <div
            ...
            "
            style={{
              transform: `rotate(${rotate - 18}deg)`,
            }}
          />
...
export default function AuthBackground({ children }: AuthBackgroundProps) {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050505]">
      ...
      <div
        className="
          absolute inset-0
          bg-[radial-gradient(circle_at_top,rgba(250,204,21,0.12),transparent_35%)]
        "
      />
      ...
      <div
        className="
          absolute inset-0
          bg-[radial-gradient(circle_at_bottom,rgba(255,255,255,0.04),transparent_45%)]
        "
      />
  ...
  "
    ...
    `,
      ...
      {/* Orbit rings */}
      <div className="absolute h-[700px] w-[700px] rounded-full border border-yellow-500/10" />

      <div className="absolute h-[1100px] w-[1100px] rounded-full border border-yellow-400/5" />

      <div className="absolute h-[1500px] w-[1500px] rounded-full border border-zinc-400/5" />
      ...
      <div
        className="
          pointer-events-none
          absolute inset-0
          bg-[radial-gradient(circle,transparent_45%,rgba(0,0,0,0.85)_100%)]
        "
      />
