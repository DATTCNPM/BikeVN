...
const defaultValues: BookingAdminFormValues = {
  user_id: "",
  vehicle_id: "",
  pickup_branch_id: "",
  return_branch_id: "",
...
export default function BookingCreate({ open, onOpenChange }: Props) {
  ...
  const onSubmit = async (values: BookingAdminFormValues) => {
    try {
      ...
      toast.error("Tạo đơn đặt xe thất bại");
    }
  };
  ...
  return (
    <EntityFormDialog
      ...
      title="Thêm đơn đặt xe"
      description="Tạo đơn đặt xe mới"
