...
//             {errors.booking_id && (
//               <FieldError>{errors.booking_id.message}</FieldError>
//             )}
//           </Field>
...
//               />
//               {errors.card_method && (
//                 <FieldError>{errors.card_method.message}</FieldError>
//               )}
//             </Field>
//           </div>
...
//               <FieldError>{errors.transaction_code.message}</FieldError>
//             )}
//           </Field>
...
//             {errors.paid_at && (
//               <FieldError>{errors.paid_at.message}</FieldError>
//             )}
//           </Field>
//         </FieldGroup>
//       </div>
