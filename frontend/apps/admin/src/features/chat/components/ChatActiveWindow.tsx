            ...
            messages.map((msg) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "flex w-full mb-2",
                    isMe ? "justify-end" : "justify-start", // Quyết định block tin nhắn nằm bên trái hay phải
                  )}
                >
                  <div
                    className={cn(
                    ...
                    <div className="flex flex-col items-end">
                      <Card
                        className={cn(
                          ...
                          isMe
                            ? "bg-primary text-primary-foreground rounded-br-none" // Màu xanh bên phải cho Admin
                            : "bg-muted text-foreground rounded-bl-none", // Màu xám bên trái cho Khách hàng
                        )}
                      >
